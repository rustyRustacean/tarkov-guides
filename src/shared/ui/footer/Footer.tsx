...
/**
 * Site-wide footer: tagline, unaffiliation disclaimer, and the "About" link
 * (Discord contact info). A repository link goes here once the project has
 * a public repo to point at.
 */
