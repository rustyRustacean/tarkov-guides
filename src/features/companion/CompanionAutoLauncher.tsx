 ...
 * *inside* the QueryClient provider. They use react-query, so they can't
 * live in the `Providers` component body (that runs above its own
 * provider); they have to be a child within the tree.
 */
