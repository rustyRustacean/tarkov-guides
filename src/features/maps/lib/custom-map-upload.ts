 ...
 * testable, matching this project's "pure lib + thin wiring hook" split.
 */
 ...
 * 15MB of source image inflates to ~20MB once base64-encoded for storage.
 */
 ...
 * file beforehand, so an error here is unexpected and should surface as one.
 */
