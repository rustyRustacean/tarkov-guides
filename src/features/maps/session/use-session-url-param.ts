 ...
 * joining is a real side effect (see the plan's join-code UX section).
 * Requires a `Suspense` boundary around its caller (`useSearchParams`'s own
 * Next.js requirement) - see `MapScreenLayout.tsx`'s use of `SessionControls`.
 */
