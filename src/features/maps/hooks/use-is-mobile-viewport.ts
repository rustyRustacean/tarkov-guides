 ...
 * `getServerSnapshot` defaults to `false` (desktop layout), the same safe
 * direction that hook uses: a server-rendered pass assumes desktop,
 * correcting to mobile immediately post-hydration if the viewport is
 * actually narrow.
 */
